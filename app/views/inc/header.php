...
<nav class="navbar navbar-expand-sm navbar-dark bg-dark sticky-top">
  <div class="container">
    <a class="navbar-brand" href="<?php echo URL ?>/home">HotWheelShop</a>
    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
      ...
      <!-- Thanh tìm kiếm cho màn hình nhỏ (sẽ hiển thị trong dropdown) -->
      <form class="form-inline my-2 my-sm-0 d-block d-md-none" action='<?php echo URL ?>/home/search' method='POST'>
        <input class="form-control mr-sm-2" type="text" name='search' placeholder="Search" aria-label="Search">
        <button class="btn btn-outline-success my-2 my-sm-0" type="submit">Search</button>
      </form>
    </div>
